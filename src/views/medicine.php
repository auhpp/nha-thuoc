...
<tbody>
    <?php foreach ($medicines as $medicine): ?>
        <tr>
            ...
            <td><?= number_format($model->getTotalValue($medicine['mathuoc']), 0, ',', '.') ?> VND</td> <!-- Gọi function -->
            <td>
...
<?php 
$totalMedicinesCount = count($allMedicines); // Đếm tổng số loại thuốc
$totalQuantity = array_sum(array_column($allMedicines, 'soluongton')); // Tính tổng số lượng thuốc
?>
...
<div class="total-summary">
    ...
    <div>
        ...
        <span>💰 Tổng tiền tất cả thuốc: <strong><?= number_format($totalAllMedicines, 0, ',', '.') ?> VND</strong></span>
    </div>
</div>
